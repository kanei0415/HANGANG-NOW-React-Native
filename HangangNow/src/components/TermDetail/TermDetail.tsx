...
4.경찰청 사이버테러대응센터(www.ctrc.go.kr/)`}
        ...
        <View>
          ...
          <Text
            ...
            {`‘한강나우’는 정보통신서비스 제공자로서 개인정보보호법 등 관계 법령에 따라 광고성 정보를 전송하기 위해 수신자의 사전 수신 동의를 받고 있으며, 광고성 정보 수신자의 수신 동의 여부를 정기적으로 확인합니다. 다만 동의하지 않을 경우, 이용목적에 따른 혜택에 제한이 있을 수 있습니다.

1.개인정보의 수집, 이용 목적

- 맞춤형 서비스 권유, 각종 뉴스레터 발송, 상품 정보 등 광고성 정보 제공
...
4.철회안내: 개인정보의 마케팅 활용 동의를 거부하시더라도 회원 가입 시 제한은 없습니다. 다만, 마케팅 활용 서비스 안내 및 참여에 제한이 있을 수 있습니다.

※ 한강나우는 별도의 동의를 받거나 법률에 특별한 규정이 있는 경우를 제외하면 제3자에게 고객님의 개인정보를 제공하지 않으며, 상기 안내해드린 개인정보 수집 동의 범위를 초과하여 고객님의 개인정보를 활용하지 않습니다.`}
          </Text>
        </View>
        <View>
          <Text
